...
export const mapBlockout: MapBlockout = {
  ...
  checkpoints: [
    ...
    },
    {
      ...
      position: { x: 0, y: 0.95, z: -55.5 },
      bounds: {
        center: { x: 0, y: 1, z: -55.5 },
        halfExtents: { x: 2.6, y: 2, z: 0.9 },
      },
    },
  ],
  staticColliders: [
    ...
    box("ChapelFacadeLeftCollision", -2.55, 1.35, -31.4, 0.85, 1.35, 0.28, 0x35373a),
    box("ChapelFacadeRightCollision", 2.55, 1.35, -31.4, 0.85, 1.35, 0.28, 0x35373a),
    box("ChapelFacadeLintelCollision", 0, 3.25, -31.4, 3.4, 1.05, 0.28, 0x35373a),
    ...
    box("BellGateApproachFloor", 0, -0.12, -52.95, 3.2, 0.12, 1.25, 0x202326),
  ...
  visualObjects: [
    ...
    boxVisual("ChapelFacadeLeft", -2.55, 2.2, -31.4, 1.7, 4.2, 0.6, 0x35373a),
    boxVisual("ChapelFacadeRight", 2.55, 2.2, -31.4, 1.7, 4.2, 0.6, 0x35373a),
    boxVisual("ChapelFacadeLintel", 0, 3.25, -31.4, 3.4, 2.1, 0.6, 0x35373a),
